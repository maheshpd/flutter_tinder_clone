...
import 'package:flutter_tinder_clone/data/explore_json.dart';
import 'package:flutter_tinder_clone/data/icons.dart';
        ...
        child: Row(
          ...
          children: List.generate(itemIcons.length, (index){
            return Container(
              ...
              child: Center(
                child: SvgPicture.asset(itemIcons[index]['icon'],
      ...
      child: Container(
        ...
        child: TinderSwapCard(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              const Text("Recently Active", style: TextStyle(
                                                color: white,
                                                fontSize: 16
                                              ),)
                                            ],
                                           ...
                                           return Padding(
                                             ...
                                             child: Container(
                                               ...
                                               child:  Padding(
                                                 ...
                                                 child: Text(itemsTemp[index]['likes'][indexLikes]),
                                               ),
                                             ),
                                           );
                                          } else {
          ...
          swipeCompleteCallback: (CardSwipeOrientation orientation, int index) {
              ///Get orientation & index of wiped card!
